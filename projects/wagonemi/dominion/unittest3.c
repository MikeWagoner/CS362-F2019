...
int main(void){
    ...
    printf("Begin Testing play_ambassador():\n");
    //
    ...
    play_ambassador(0, 1, 2, p, &G);
    // verify that your asserts pass, for the bugs your asserts may fail
    assert(!(G.hand[p][0] == discard_card)); // Checks that the copper card in handpos 0 is discarded properly
